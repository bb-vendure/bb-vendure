...
import { EventBus, ProductEvent, PluginCommonModule, VendurePlugin } from '@bb-vendure/core';
...
import { EventBus, ProductEvent, RequestContext, Product } from '@bb-vendure/core';
...
import { ID, RequestContext, VendureEvent } from '@bb-vendure/core';
...
import { Injectable } from '@nestjs/common';
import { EventBus, ProductReviewService, RequestContext } from '@bb-vendure/core';
...
import { ID, RequestContext, VendureEntityEvent } from '@bb-vendure/core';
...
```ts title="src/plugins/my-plugin/my-plugin.plugin.ts"
import { Injectable, OnModuleInit } from '@nestjs/common';
import { EventBus, PluginCommonModule, VendurePlugin, CustomerEvent } from '@bb-vendure/core';
