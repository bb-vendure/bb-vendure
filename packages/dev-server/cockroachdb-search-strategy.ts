import { LogicalOperator, SearchInput, SearchResult } from '@bb-vendure/common/lib/generated-types';
...
import { SearchIndexItem } from '@bb-vendure/core/dist/plugin/default-search-plugin/entities/search-index-item.entity';
import { SearchStrategy } from '@bb-vendure/core/dist/plugin/default-search-plugin/search-strategy/search-strategy';
import { getFieldsToSelect } from '@bb-vendure/core/dist/plugin/default-search-plugin/search-strategy/search-strategy-common';
import {
    ...
    mapToSearchResult,
} from '@bb-vendure/core/dist/plugin/default-search-plugin/search-strategy/search-strategy-utils';
import { DefaultSearchPluginInitOptions } from '@bb-vendure/core/dist/plugin/default-search-plugin/types';
